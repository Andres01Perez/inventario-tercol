...
const InventarioMP: React.FC = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ referencia, field, value }: { referencia: string; field: string; value: string }) => {
      ...
      const numericFields = ['cant_alm_mp', 'cant_prov_d', 'cant_prov_r', 'cant_t_mp', 'costo_u_mp', 'mp_costo', 'mo_costo', 'servicio', 'costo_t'];
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['inventory-mp'] });
  ...
  const columns = [
    ...
    { key: 'control', label: 'Control', editable: true, type: 'text' as const },
    { key: 'cant_alm_mp', label: 'Cant. Almacén', editable: true, type: 'number' as const },
    { key: 'cant_prov_d', label: 'Cant. Prov D', editable: true, type: 'number' as const },
    { key: 'cant_prov_r', label: 'Cant. Prov R', editable: true, type: 'number' as const },
    { key: 'cant_t_mp', label: 'Cant. Total', editable: true, type: 'number' as const },
    { key: 'costo_u_mp', label: 'Costo Unit.', editable: true, type: 'number' as const },
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-foreground">Inventario Materia Prima</h1>
        ...
        <div className="bg-card rounded-lg border border-border overflow-hidden">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground">No hay referencias de MP</p>
