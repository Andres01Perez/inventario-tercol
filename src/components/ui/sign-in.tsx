  ...
  return <div className="h-[100dvh] flex flex-col md:flex-row font-sans w-[100dvw]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              <div className="animate-element animate-delay-400">
                ...
                <GlassInputWrapper>
                  <input name="email" type="email" placeholder="usuario@tercol.com" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none text-foreground placeholder:text-muted-foreground" />
                </GlassInputWrapper>
              </div>
              ...
              <div className="animate-element animate-delay-500">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Ingresa tu contraseña" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none text-foreground placeholder:text-muted-foreground" />
              ...
              <button type="submit" className="animate-element animate-delay-700 w-full rounded-2xl gradient-bg py-4 font-medium text-primary-foreground hover:opacity-90 transition-all shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5">
                Iniciar Sesión
              </button>
            </form>
            ...
            <p className="animate-element animate-delay-800 text-center text-sm text-muted-foreground">
              ...
              <button onClick={onCreateAccount} className="text-primary hover:underline transition-colors">
                Crear Cuenta
              </button>
            </p>
      ...
      {heroImageSrc && <section className="hidden md:block flex-1 relative p-4">
        ...
        backgroundImage: `url(${heroImageSrc})`
          ...
          {testimonials.length > 0 && <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-4 px-8 w-full justify-center z-10">
              <TestimonialCard testimonial={testimonials[0]} delay="animate-delay-1000" />
              {testimonials[1] && <div className="hidden xl:flex">
                  <TestimonialCard testimonial={testimonials[1]} delay="animate-delay-1200" />
                </div>}
              {testimonials[2] && <div className="hidden 2xl:flex">
