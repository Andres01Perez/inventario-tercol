...
export interface BulkLocationItem {
  id: string;
...
export interface BulkPrintGroup {
  key: string;
  zoneName: string;
  supervisorName: string;
  locations: BulkLocationItem[];
}

interface BulkPrintableSheetsProps {
  open: boolean;
...
export default BulkPrintableSheets;
