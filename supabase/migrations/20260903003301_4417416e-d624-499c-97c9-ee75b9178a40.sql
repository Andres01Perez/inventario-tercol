...
BEGIN
  ...
  IF v_round = 1 THEN
    IF v_sum_c1 = v_erp THEN v_matched_round := 'C1=ERP'; v_matched_total := v_sum_c1;
    ELSIF v_sum_c2 = v_erp THEN v_matched_round := 'C2=ERP'; v_matched_total := v_sum_c2;
    ELSIF v_sum_c1 = v_sum_c2 THEN v_matched_round := 'C1=C2'; v_matched_total := v_sum_c1;
    END IF;
  ELSIF v_round = 3 THEN
    IF v_sum_c3 = v_erp THEN v_matched_round := 'C3=ERP'; v_matched_total := v_sum_c3;
    ELSIF v_sum_c3 = v_sum_c1 THEN v_matched_round := 'C3=C1'; v_matched_total := v_sum_c3;
    ELSIF v_sum_c3 = v_sum_c2 THEN v_matched_round := 'C3=C2'; v_matched_total := v_sum_c3;
    END IF;
  ELSIF v_round = 4 THEN
    IF v_sum_c4 = v_erp THEN v_matched_round := 'C4=ERP'; v_matched_total := v_sum_c4;
    ELSIF v_sum_c4 = v_sum_c3 THEN v_matched_round := 'C4=C3'; v_matched_total := v_sum_c4;
    ELSIF v_sum_c4 = v_sum_c2 THEN v_matched_round := 'C4=C2'; v_matched_total := v_sum_c4;
    ELSIF v_sum_c4 = v_sum_c1 THEN v_matched_round := 'C4=C1'; v_matched_total := v_sum_c4;
    END IF;
  END IF;
