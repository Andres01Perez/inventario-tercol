-- Actualizar validate_and_close_round para verificar que existan conteos de la ronda actual antes de escalar
...
DECLARE
  ...
  -- Variable para verificar si hay conteos de la ronda actual
  v_has_current_round_counts BOOLEAN := FALSE;
BEGIN
  ...
  -- ==============================================================================
  -- NUEVA VALIDACIÓN: Verificar que existan conteos de la ronda actual antes de escalar
  -- ==============================================================================
  IF v_master.audit_round = 3 AND v_sum_c3 = 0 THEN
    RETURN jsonb_build_object(
      'success', false, 
      'action', 'waiting_for_counts', 
      'round', 3,
      'message', 'Esperando conteos de ronda 3'
    );
  END IF;
  ...
  IF v_master.audit_round = 4 AND v_sum_c4 = 0 THEN
    RETURN jsonb_build_object(
      ...
      'action', 'waiting_for_counts', 
      'round', 4,
      'message', 'Esperando conteos de ronda 4'
    );
  END IF;
